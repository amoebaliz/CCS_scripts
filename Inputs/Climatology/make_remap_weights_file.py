...
# load the grid
srcgrd = pyroms_toolbox.BGrid_GFDL.get_nc_BGrid_GFDL('/glade/p/work/edrenkar/external_data/SODA/SODA3.4.1_0.25deg_grid_sub.nc', name='SODA3_0.25deg', xrange=(1,198), yrange=(1, 198))
