...
def remap_uv(src_fileuv, src_grd, dst_grd, dst_fileu, dst_filev, cdepth=0, kk=2, dst_dir='./', dmax=0,):
    # CCS grid sub-sample
    ...
    # rotate u,v fields
    #src_angle = pyroms.remapping.remap(src_grd.angle, 'remap_weights_SODA3.3.1_CCS_to_CCS_bilinear_t_to_rho.nc', \
    #                                  spval=spval)
