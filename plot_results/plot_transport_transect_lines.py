...
#    m.plot((plon[eta_rhos[nt],xi_rhos[nt,0]],plon[eta_rhos[nt],xi_rhos[nt,1]]),\
#           (plat[eta_rhos[nt],xi_rhos[nt,0]],plat[eta_rhos[nt],xi_rhos[nt,1]]),\
#           linewidth=2,color='k',zorder=map_order+8)

    m.plot((plon[eta_rhos[nt,0],xi_rhos[nt]],plon[eta_rhos[nt,1],xi_rhos[nt]]),\
           (plat[eta_rhos[nt,0],xi_rhos[nt]],plat[eta_rhos[nt,1],xi_rhos[nt]]),\
           linewidth=2,color='k',zorder=map_order+8) 
