...
def plot_annual_maps():
    ...
    for n in range(nplot):
        ...
        if n:
           ...
           plt_str = 'CCS_ROMS_vs_OISST:avg_diff_RMS'
           plt.savefig(plt_str)
           plt.show()
        else:
...
# SODA SST CLIM
#SST_roms = nc.Dataset('SODA_SST_CLIM_CCS_ROMS_config.nc').variables['temp'][:].squeeze()

# AVHRR - self_acquired
#avh_dir = '/Users/elizabethdrenkard/TOOLS/CCS_scripts/Validation/AVHRR_day_night_clim/'

# OISST
avh_dir = '/Users/elizabethdrenkard/TOOLS/CCS_scripts/Validation/OISST_daily/'
...
for nmon in range(12):
    ...
    avh_fil = avh_dir + 'oisst_' + str(nmon+1).zfill(2) + '.nc.orig' 
