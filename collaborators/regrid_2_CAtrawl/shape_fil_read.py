...
def plt_shp_coord(sf,m_fin):
    ...
    for shape in sf.shapeRecords():
        ...
        m_fin.plot(lons,lats,'.1',lw=6,zorder=map_order+10)
        m_fin.plot(lons,lats,'paleturquoise',lw=1.5,zorder=map_order+10)
...
shp_file = '/Users/elizabethdrenkard/TOOLS/CCS_scripts/colaborators/caltrawl/caltrawl.shp'
